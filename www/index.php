...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en   ">
  ...
  <head>
	...
	<title>rErlang R/Erlang Interface </title>
...
<p>To communicate with R, Erlang ports (Ports), ei (Erlang Interface) library and OTP standard behaviors are used in Erlang side. Ports provides a byte-oriented interface to an external program. ei helps conversion of data between C and Erlang formats. And also we want to ensure that rErlang is robust in the event that the external problems or does not respond in a timely manner. The use of standard OTP enables us to do so with minimal effort.</p>
<h2>What's new?</h2>
<table>
